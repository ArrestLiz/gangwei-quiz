...
// 中期测试发布配置（管理员发布，所有用户共享同一浏览器）
export function getMidtermConfig() {
  return read(null, 'midtermConfig')
}
export function saveMidtermConfig(config) {
  write(null, 'midtermConfig', config)
}
